                ...
                <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                        ...
                        <form onSubmit={handleCreateOrUpdate} className="p-6 space-y-4">
                            <div>
                                <label htmlFor="nomorKamar" className="block text-sm font-medium text-gray-700 mb-1">Room Number</label>
                                <input
                                    id="nomorKamar"
                                    type="text"
                                    required
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="tipe" className="block text-sm font-medium text-gray-700 mb-1">Type</label>
                                    <select
                                        id="tipe"
                                ...
                                <div>
                                    <label htmlFor="harga" className="block text-sm font-medium text-gray-700 mb-1">Price</label>
                                    <input
                                        id="harga"
                                        type="number"
                                        required
                            ...
                            <div className="mb-4">
                                <label htmlFor="upload-btn" className="block text-sm font-bold mb-2">Image</label>
                            ...
                            <div>
                                <label htmlFor="statusKamar" className="block text-sm font-medium text-gray-700 mb-1">Status</label>
                                <select
                                    id="statusKamar"
                                    className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[var(--color-gold-400)] outline-none text-gray-900"
                            ...
                            <div>
                                <label htmlFor="fasilitasTambahan" className="block text-sm font-medium text-gray-700 mb-1">Facilities</label>
                                <textarea
                                    id="fasilitasTambahan"
                                    className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[var(--color-gold-400)] outline-none text-gray-900"
                                    rows={3}
